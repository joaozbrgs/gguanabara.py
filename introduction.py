...
while True:
    ...
    while True:
        a01 = md.intvalid(input('Chose a shortcut: '))
        if a01 in range(0,4):
            break
        else:
            print('\nOut of range')
    ...
    #lists'[]'
        ...
        l02[3] = 420
        print(f'List A: {l01}. Realize that I changed the value on the List B, but both received the new 420 because they are connected')
        print(f'List B: {l02}')
